...
public class Member 
{
	...
	public Member(String firstName , String lastName, String email, String username, String password, ArrayList<String> subject) 
	{
	...
	{
		return firstname+" "+lastName+","+email+","+username+","+password+","+allSubject()+"\n";		
	}
